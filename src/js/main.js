...
// Number of moving pizzas on the background of the page, 8 by row
  var number_bg_pizzas = 32;
...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    ...
    // Creation of the variable randomPizzas outside of the loop
    var randomPizzas = document.querySelectorAll(".randomPizzaContainer");
    // Iterates between the pizzas and changes the sizes
...
function updatePositions() {
  ...
  // Creation of the variable scrollTop outside of the loop
  var scrollTop = document.body.scrollTop / 1250;

  // Operations for the phase calc moved outside the loop
  var phase;
  var constantArray = [];
  var items = document.querySelectorAll('.mover');
  for(var i = 0; i < 5; i++) {
    constantArray.push(Math.sin(scrollTop + i));
  }

  for(i = 0; i < number_bg_pizzas; i++) {
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  var cols = 8;
  var s = 256;
  for (var i = 0; i < number_bg_pizzas; i++) {
